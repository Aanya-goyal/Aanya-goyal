...
void mergeSortedArrays(int* nums1, int size1, int* nums2, int size2, int* mergedArray) {
    int i = 0, j = 0, k = 0;
...
int main() {
    int nums1[MAX_SIZE], nums2[MAX_SIZE], mergedArray[2 * MAX_SIZE];
    int size1, size2;
    ...
    mergeSortedArrays(nums1, size1, nums2, size2, mergedArray);
